    ...
    public class HttpHelper
    {
        ...
        public static int GetParamValue(string paramName, int defaultValue)
        {
            ...
            try
            {
                ...
                {
                    if( int.TryParse( paramValue , out ret ) == false)
                        ret = defaultValue;
                }
            }
            catch
        ...
        public static long GetParamValue(string paramName, long defaultValue)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(paramValue))
                {
                    if (long.TryParse(paramValue, out ret) == false)
                        ret = defaultValue;
                }
            }
            catch
        ...
        public static double GetParamValue(string paramName, double defaultValue)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(paramValue))
                {
                    if (double.TryParse(paramValue, out ret) == false)
                        ret = defaultValue;
                }
            }
            catch
        ...
        public static string GetParamValue(string paramName, string defaultValue)
        {
            ...
            try
            {
                ...
                /*else*/ 
                {
                    ...
                    {
                        var formValue =  HttpFormDecryptModule.GetItem(paramName);
                    ...
                    else*/
                    {
                        ...
                        {
                            ret = HttpContext.Current.Request.Form[paramName];
                        }
                    }
                }
            }
        ...
        public static bool GetParamValue(string paramName, bool defaultValue)
        {
            ...
            {
                string paramValue = GetParamValue(paramName, "");
                ret = string.Compare(paramValue , "true", true ) == 0 ;
            }
            catch
            {
            }
        ...
        /// <param name="defaultValue">默认值</param>
        /// <returns></returns>
        public static DateTime GetParamValue(string paramName, DateTime defaultValue)
        {
            ...
            try
            {
                ...
                if (DateTime.TryParse(paramValue ,out ret) == false )
                    ret = defaultValue;
            }
            catch
            {
